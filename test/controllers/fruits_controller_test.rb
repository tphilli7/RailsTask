...
class FruitsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fruit" do
    assert_difference('Fruit.count') do
      post fruits_url, params: { fruit: { color: @fruit.color, facts: @fruit.facts, name: @fruit.name } }
    end
  ...
  test "should update fruit" do
    patch fruit_url(@fruit), params: { fruit: { color: @fruit.color, facts: @fruit.facts, name: @fruit.name } }
